//simple gaussian elimination (direct data entry)
#include<iostream>
#include<cstdlib>
using namespace std;
int main()
{int n,i,j,p;float M;//defining parameters
    ...
    for(i=1;i<=n;i++){for(j=1;j<=(n+1);j++){cout<<"enter coefficient "<<j<<" of row "<<i<<"  for augmented matrix  ";cin>> matrix [i][j];}}//user entry of augmented coefficients
